...
describe("Proofs Validator", () => {
    ...
    const getLeaderPk = (view: number) => membersPKs[view];
    ...
    it("should reject a proof with a mismatching view to leader", async () => {
        ...
        const getLeaderPk = (view: number) => ["Node 1", "Node 2", "Node 3", "Node 4"][view];
    ...
    it("should reject a proof that has a prepare that did not match the preprepare view or term", async () => {
        ...
        const actualGood = validatePrepared(goodPrepareProof, f, keyManager, blockUtils, membersPKs, getLeaderPk);
        ...
        const actualBadTerm = validatePrepared(badTermPrepareProof, f, keyManager, blockUtils, membersPKs, getLeaderPk);
        ...
        const actualBadView = validatePrepared(badViewPrepareProof, f, keyManager, blockUtils, membersPKs, getLeaderPk);
        ...
        const actualBadBlockHash = validatePrepared(badBlockHashPrepareProof, f, keyManager, blockUtils, membersPKs, getLeaderPk);
